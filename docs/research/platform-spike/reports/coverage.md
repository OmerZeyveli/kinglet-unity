...
| `client.claude-code.linux-ubuntu-24-04-x64.local-executable` | missing | — |
| `client.claude-code.linux-ubuntu-24-04-x64.mcp-discovery` | missing | — |
| `client.claude-code.linux-ubuntu-24-04-x64.path-semantics` | missing | — |
